...
| 2026-07-11 | [**Fable upgrade pass — v1.1/v1.2 + guide polish**](sessions/2026-07-11-fable-upgrade-v1.1-v1.2-guide-polish.md) | Context-aware Fanatec-official values wired in, profile dial-in view with tap-to-edit, unified search, Setup Guide wizard, troubleshooter fix-session tracking, compare-vs-recommended, PWA shortcuts. Three live feedback rounds shipped same-session. 8 commits, v1.2.0. |
